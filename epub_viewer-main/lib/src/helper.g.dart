...
EpubChapter _$EpubChapterFromJson(Map<dynamic, dynamic> json) => EpubChapter(
      title: json['title'] as String,
      href: json['href'] as String,
      id: json['id'] as String,
      subitems: (json['subitems'] as List<dynamic>)
          .map((e) => EpubChapter.fromJson(e as Map<dynamic, dynamic>))
          .toList(),
    );
...
EpubLocation _$EpubLocationFromJson(Map<dynamic, dynamic> json) => EpubLocation(
      startCfi: json['startCfi'] as String,
      endCfi: json['endCfi'] as String,
      progress: (json['progress'] as num).toDouble(),
    );

Map<dynamic, dynamic> _$EpubLocationToJson(EpubLocation instance) =>
    <dynamic, dynamic>{
