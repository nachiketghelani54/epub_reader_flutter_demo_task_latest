...
class EpubChapter {
  ...
  factory EpubChapter.fromJson(Map<dynamic, dynamic> json) =>
      _$EpubChapterFromJson(json);
  Map<dynamic, dynamic> toJson() => _$EpubChapterToJson(this);
}
...
class EpubLocation {
  ...
  factory EpubLocation.fromJson(Map<dynamic, dynamic> json) =>
      _$EpubLocationFromJson(json);
  Map<dynamic, dynamic> toJson() => _$EpubLocationToJson(this);
}
